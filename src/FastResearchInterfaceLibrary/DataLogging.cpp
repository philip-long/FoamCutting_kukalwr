                            ...
                            ,   const RESPONSE           &resp)
{
	...
	if (this->CurrentControlScheme == FastResearchInterface::JOINT_POSITION_CONTROL)
	{
        ...
        for (i=0;i<6;i++)
        {
            this->LoggingMemory[ 2 + 4 * LBR_MNJ + i][this->OutputCounter % this->MaximumNumberOfEntries] = resp.FTData[i];
        }
	...
	if (this->CurrentControlScheme == FastResearchInterface::CART_IMPEDANCE_CONTROL)
	{
        ...
        for (i=0;i<6;i++)
        {
            this->LoggingMemory[ 2 + 3 * FRI_CART_VEC + i][this->OutputCounter % this->MaximumNumberOfEntries] = resp.FTData[i];
        }
	}
	...
	if (this->CurrentControlScheme == FastResearchInterface::JOINT_IMPEDANCE_CONTROL)
	{
        ...
        for (i=0;i<6;i++)
        {
            this->LoggingMemory[ 2 + 8 * LBR_MNJ + i][this->OutputCounter % this->MaximumNumberOfEntries] = resp.FTData[i];
        }
	}
